...
from lavis_paddle.processors.randaugment import RandomAugment
...
class BlipImageBaseProcessor(BaseProcessor):
    def __init__(self, mean=None, std=None):
        super(BlipImageBaseProcessor, self).__init__()
        if mean is None:
...
class BlipCaptionProcessor(BaseProcessor):
    def __init__(self, prompt="", max_words=50):
        super(BlipCaptionProcessor, self).__init__()
        self.prompt = prompt
...
class BlipQuestionProcessor(BaseProcessor):
    def __init__(self, max_words=50):
        super(BlipQuestionProcessor, self).__init__()
        self.max_words = max_words
